...
|---|---:|---|
| `app.py` | 5490 | The entire UI: tabs, tables, sidebar, filters, sort, editors, AI control bars, News + Alert Rules tabs |
...
Tabs are registry-driven (`markets.json`), currently 5 watchlists, plus two **combined
tabs** (`all_invested`, `all_watchlist`) whose membership lives in `watchlist_groups.json`.
